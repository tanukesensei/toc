      ...
      <div class="row">
        <div class="col-sm-4 col-sm-offset-4">
          <form class="" action="/colecao/store" method="post"  class="form-group" enctype="multipart/form-data">
            ...
            <input type="text" name="nome" placeholder="Nome da coleção" class="form-control" required>

            <input type="text" name="descricao" value="" placeholder="Descrição" class="form-control" required>
            ...
            <input type="text" name="autor" value="" placeholder="Autor" class="form-control" required>
